...
(function () {
  ...
  var pageIndex = [
    { title: 'Weight Loss Programs', desc: 'Mounjaro, Wegovy & GLP-1 weight management in Chislehurst', url: 'https://chislehurstpharmacygroup.co.uk/medical-weight-loss-london/', category: 'Services', keywords: 'weight loss mounjaro wegovy glp-1 ozempic slimming obesity bmi diet injection tirzepatide semaglutide chislehurst' },
    ...
    { title: 'HPV Vaccine (Gardasil 9)', desc: 'HPV vaccination for cervical cancer protection in London', url: 'https://chislehurstpharmacygroup.co.uk/hpv-vaccine-london/', category: 'Services', keywords: 'hpv vaccine gardasil 9 cervical cancer human papillomavirus warts vaccination london' },
    ...
    { title: 'Meet the Team', desc: 'Meet our experienced pharmacists at Chislehurst Pharmacy Group', url: 'meet-the-team.html', category: 'About', keywords: 'team pharmacist pharmacists staff sumeet about us meet' },
    ...
    { title: 'Pharmacy First', desc: 'Free NHS treatment for 7 common conditions without a GP referral', url: 'https://chislehurstpharmacygroup.co.uk/pharmacy-first-london/', category: 'NHS Services', keywords: 'pharmacy first nhs free treatment 7 conditions sore throat uti skin infection gp referral' },
