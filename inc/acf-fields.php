...
acf_add_local_field_group( array(
    ...
    'fields'   => array(
        ...
        array( 'key' => 'field_rl_mt_lead_name', 'label' => 'Lead Name', 'name' => 'mt_lead_name', 'type' => 'text', 'default_value' => 'Sumeet Banker' ),
        ...
        array( 'key' => 'field_rl_mt_lead_cta_text', 'label' => 'Lead CTA Button Text', 'name' => 'mt_lead_cta_text', 'type' => 'text', 'default_value' => 'Book a Consultation' ),
        array(
...
acf_add_local_field_group( array(
    ...
    'fields'   => array(
        ...
        array( 'key' => 'field_rl_hh_featured_tab', 'label' => "Editor's Pick", 'type' => 'tab' ),
        array( 'key' => 'field_rl_hh_feat_image', 'label' => 'Image', 'name' => 'hh_feat_image', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium' ),
        array( 'key' => 'field_rl_hh_feat_image_alt', 'label' => 'Image Alt Text', 'name' => 'hh_feat_image_alt', 'type' => 'text' ),
        array( 'key' => 'field_rl_hh_feat_category', 'label' => 'Category Label', 'name' => 'hh_feat_category', 'type' => 'select', 'choices' => array( 'wellness' => 'Wellness', 'travel-health' => 'Travel Health', 'weight-loss' => 'Weight Loss', 'seasonal' => 'Seasonal Health', 'prescriptions' => 'Prescriptions' ), 'default_value' => 'weight-loss', 'return_format' => 'value' ),
        array( 'key' => 'field_rl_hh_feat_category_text', 'label' => 'Category Badge Text', 'name' => 'hh_feat_category_text', 'type' => 'text', 'instructions' => 'Text shown on the badge (e.g. "WEIGHT LOSS").', 'default_value' => 'WEIGHT LOSS' ),
        array( 'key' => 'field_rl_hh_feat_date', 'label' => 'Date', 'name' => 'hh_feat_date', 'type' => 'date_picker', 'display_format' => 'M d, Y', 'return_format' => 'M d, Y' ),
        array( 'key' => 'field_rl_hh_feat_read_time', 'label' => 'Read Time', 'name' => 'hh_feat_read_time', 'type' => 'text', 'default_value' => '8 min read' ),
        array( 'key' => 'field_rl_hh_feat_title', 'label' => 'Title', 'name' => 'hh_feat_title', 'type' => 'text', 'default_value' => 'Mounjaro vs Wegovy: What the Clinical Trials Actually Show' ),
        array( 'key' => 'field_rl_hh_feat_excerpt', 'label' => 'Excerpt', 'name' => 'hh_feat_excerpt', 'type' => 'textarea', 'rows' => 4, 'default_value' => '"My GP mentioned Wegovy. But my friend lost heaps of weight on Mounjaro. Are they the same thing? Should I ask for the other one?" Two of the most-prescribed GLP-1 medications — but they work differently, cost differently, and suit different patients. Our lead pharmacist breaks down what the data actually shows.' ),
        ...
        array(
            ...
            'instructions' => 'Cards shown in the "Latest from Our Pharmacists" grid.',
            'min' => 0, 'max' => 12, 'layout' => 'block', 'button_label' => 'Add Article',
            'sub_fields' => array(
                array( 'key' => 'field_rl_hh_art_image', 'label' => 'Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium' ),
                array( 'key' => 'field_rl_hh_art_image_alt', 'label' => 'Image Alt Text', 'name' => 'image_alt', 'type' => 'text' ),
                array( 'key' => 'field_rl_hh_art_category', 'label' => 'Category', 'name' => 'category', 'type' => 'select', 'choices' => array( 'wellness' => 'Wellness', 'travel-health' => 'Travel Health', 'weight-loss' => 'Weight Loss', 'seasonal' => 'Seasonal Health', 'prescriptions' => 'Prescriptions' ), 'default_value' => 'wellness', 'return_format' => 'value' ),
                array( 'key' => 'field_rl_hh_art_category_text', 'label' => 'Category Badge Text', 'name' => 'category_text', 'type' => 'text', 'instructions' => 'e.g. "WELLNESS", "TRAVEL HEALTH".' ),
                array( 'key' => 'field_rl_hh_art_date', 'label' => 'Date', 'name' => 'date', 'type' => 'date_picker', 'display_format' => 'M d, Y', 'return_format' => 'M d, Y' ),
                array( 'key' => 'field_rl_hh_art_read_time', 'label' => 'Read Time', 'name' => 'read_time', 'type' => 'text', 'default_value' => '5 min read' ),
                array( 'key' => 'field_rl_hh_art_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                array( 'key' => 'field_rl_hh_art_excerpt', 'label' => 'Excerpt', 'name' => 'excerpt', 'type' => 'textarea', 'rows' => 3 ),
                array( 'key' => 'field_rl_hh_art_url', 'label' => 'Article URL', 'name' => 'url', 'type' => 'url' ),
                array( 'key' => 'field_rl_hh_art_author_title', 'label' => 'Author Title Override', 'name' => 'author_title', 'type' => 'text', 'instructions' => 'Leave blank to use the Default Author title.' ),
            ),
        ),
    ),
...
acf_add_local_field_group( array(
    ...
    'fields'   => array(
        ...
        array( 'key' => 'field_rl_rx_hero_subtitle', 'label' => 'Hero Subtitle', 'name' => 'rx_hero_subtitle', 'type' => 'textarea', 'rows' => 4, 'default_value' => 'Online ordering, automatic refills, and same-day collection. Your prescriptions managed by our GPhC-registered pharmacists.' ),
        array( 'key' => 'field_rl_rx_hero_image', 'label' => 'Hero Image', 'name' => 'rx_hero_image', 'type' => 'image', 'return_format' => 'url', 'preview_size' => 'medium', 'instructions' => 'Recommended size: 700×600px' ),
        ...
        array( 'key' => 'field_rl_rx_services_tab', 'label' => 'How It Works', 'type' => 'tab' ),
        array( 'key' => 'field_rl_rx_hiw_title', 'label' => 'Section Title', 'name' => 'rx_hiw_title', 'type' => 'text', 'default_value' => 'Simple Prescription Management' ),
        array( 'key' => 'field_rl_rx_hiw_subtitle', 'label' => 'Section Subtitle', 'name' => 'rx_hiw_subtitle', 'type' => 'text', 'default_value' => 'Managing your NHS or private prescriptions has never been easier.' ),
        array( 'key' => 'field_rl_rx_hiw_intro', 'label' => 'Intro Text', 'name' => 'rx_hiw_intro', 'type' => 'wysiwyg', 'toolbar' => 'basic', 'media_upload' => 0 ),
        array(
            'key' => 'field_rl_rx_steps', 'label' => 'Steps', 'name' => 'rx_steps', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Step', 'max' => 4,
            'sub_fields' => array(
                array( 'key' => 'field_rl_rx_step_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                array( 'key' => 'field_rl_rx_step_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
                array( 'key' => 'field_rl_rx_step_img', 'label' => 'Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'url', 'preview_size' => 'medium' ),
            ),
        ),
        array( 'key' => 'field_rl_rx_delivery_tab', 'label' => 'Free Delivery', 'type' => 'tab' ),
        array( 'key' => 'field_rl_rx_del_title', 'label' => 'Section Title', 'name' => 'rx_delivery_title', 'type' => 'text', 'default_value' => 'Free NHS Prescription Delivery Across South East London' ),
        array( 'key' => 'field_rl_rx_del_subtitle', 'label' => 'Section Subtitle', 'name' => 'rx_delivery_subtitle', 'type' => 'text', 'default_value' => 'No minimum order. No hidden fees. Just your medication, delivered on time.' ),
        array( 'key' => 'field_rl_rx_del_intro', 'label' => 'Intro Text', 'name' => 'rx_delivery_intro', 'type' => 'wysiwyg', 'toolbar' => 'basic', 'media_upload' => 0 ),
        array(
            'key' => 'field_rl_rx_del_features', 'label' => 'Feature Cards', 'name' => 'rx_delivery_features', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Feature', 'max' => 4,
            'sub_fields' => array(
                array( 'key' => 'field_rl_rx_del_feat_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                array( 'key' => 'field_rl_rx_del_feat_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
            ),
        ),
        ...
        array(
            'key' => 'field_rl_rx_online_benefits', 'label' => 'Benefits', 'name' => 'rx_online_benefits', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Benefit', 'max' => 6,
            'sub_fields' => array(
                array( 'key' => 'field_rl_rx_online_ben_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                array( 'key' => 'field_rl_rx_online_ben_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
            ),
        ),
        array( 'key' => 'field_rl_rx_repeat_tab', 'label' => 'Repeat Dispensing', 'type' => 'tab' ),
        array( 'key' => 'field_rl_rx_repeat_title', 'label' => 'Section Title', 'name' => 'rx_repeat_title', 'type' => 'text', 'default_value' => 'What is NHS Repeat Dispensing?' ),
        array( 'key' => 'field_rl_rx_repeat_subtitle', 'label' => 'Section Subtitle', 'name' => 'rx_repeat_subtitle', 'type' => 'text', 'default_value' => 'A smarter way to manage your long-term medications — we handle it for you.' ),
        array( 'key' => 'field_rl_rx_repeat_body', 'label' => 'Body Text', 'name' => 'rx_repeat_body', 'type' => 'wysiwyg', 'toolbar' => 'basic', 'media_upload' => 0 ),
        array(
            'key' => 'field_rl_rx_repeat_cards', 'label' => 'Benefit Cards', 'name' => 'rx_repeat_benefits', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Benefit', 'max' => 4,
            'sub_fields' => array(
                array( 'key' => 'field_rl_rx_repeat_card_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
                array( 'key' => 'field_rl_rx_repeat_card_desc', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 2 ),
            ),
        ),
        array( 'key' => 'field_rl_rx_accept_tab', 'label' => 'What We Accept', 'type' => 'tab' ),
        array( 'key' => 'field_rl_rx_accept_title', 'label' => 'Section Title', 'name' => 'rx_accept_title', 'type' => 'text', 'default_value' => 'NHS & Private Prescriptions Welcome' ),
        array( 'key' => 'field_rl_rx_accept_subtitle', 'label' => 'Section Subtitle', 'name' => 'rx_accept_subtitle', 'type' => 'text', 'default_value' => 'Whatever your prescription type, we have you covered at both locations.' ),
        array( 'key' => 'field_rl_rx_accept_nhs', 'label' => 'NHS Prescription Items (one per line)', 'name' => 'rx_accept_nhs', 'type' => 'textarea', 'rows' => 8 ),
        ...
        array(
            'key' => 'field_rl_rx_collect_steps', 'label' => 'Steps', 'name' => 'rx_collect_steps', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Step', 'max' => 4,
            'sub_fields' => array(
                array( 'key' => 'field_rl_rx_collect_step_text', 'label' => 'Step Text', 'name' => 'text', 'type' => 'text' ),
            ),
        ),
