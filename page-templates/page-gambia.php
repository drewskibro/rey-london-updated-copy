    ...
    <div class="container th-hero-container">
      <div class="th-hero-content">
        <div class="th-hero-badge">
          ...
          <span>Gambia Travel Health</span>
        </div>
        <h1 class="th-hero-title"><?php echo esc_html( rl_field( 'gambia_hero_title', 'Gambia Travel Vaccinations in South East London' ) ); ?></h1>
        <p class="th-hero-subtitle"><?php echo esc_html( rl_field( 'gambia_hero_subtitle', 'Expert travel health advice and essential vaccines for your Gambia trip. Same-day appointments available at our Chislehurst and Pond End clinics.' ) ); ?></p>
      ...
      <div class="th-vaccine-category">
        ...
        <div class="th-vaccine-grid">
          ...
          <div class="th-vaccine-card">
            ...
            <p class="th-vaccine-desc">Recommended if visiting rural areas, especially rural areas of The Gambia, or staying for extended periods. Spread by mosquitoes and can cause serious neurological illness.</p>
            <div class="th-vaccine-meta">
              <span class="th-vaccine-who">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
