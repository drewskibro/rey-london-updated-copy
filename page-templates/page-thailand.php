<?php
/**
 * Template Name: Thailand Travel Health
...
?>
    ...
    <div class="container">
      ...
      <div class="th-vaccine-category">
        ...
        <div class="th-vaccine-grid">
          ...
          <div class="th-vaccine-card">
            ...
            <p class="th-vaccine-desc">Highly recommended for Thailand. Spread through contaminated food and water, Hepatitis A is common in Southeast Asia. Provides long-term immunity.</p>
            <div class="th-vaccine-meta">
              <span class="th-vaccine-who">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
                All travellers
      ...
      <div class="th-vaccine-category">
        <div class="th-category-header th-category-recommended">
          ...
          <div>
            <h3>Recommended Vaccines for Thailand</h3>
        ...
        <div class="th-vaccine-grid">
          ...
          <div class="th-vaccine-card">
            ...
            <p class="th-vaccine-desc">Common in areas with poor sanitation. Spread through contaminated food and water. Essential if you plan to eat street food or travel outside major tourist areas.</p>
            <div class="th-vaccine-meta">
              <span class="th-vaccine-who">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
          ...
          <div class="th-vaccine-card">
            <div class="th-vaccine-name">Japanese Encephalitis</div>
            <div class="th-vaccine-full">JE Virus</div>
            <p class="th-vaccine-desc">Recommended if visiting rural areas, especially rice-growing regions, or staying for extended periods. Spread by mosquitoes and can cause serious neurological illness.</p>
            <div class="th-vaccine-meta">
              <span class="th-vaccine-who">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
          ...
          <div class="th-vaccine-card">
            ...
            <p class="th-vaccine-desc">Strongly recommended for adventure travellers, cyclists, and those visiting remote areas. Stray dogs and monkeys are common in Thailand and rabies is present.</p>
            <div class="th-vaccine-meta">
              <span class="th-vaccine-who">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
  ...
  <div class="th-lifestyle-banner">
    <div class="th-lifestyle-img-wrap">
      <img src="https://images.unsplash.com/photo-1506665531195-3566af2b4dfa?w=1400&h=500&fit=crop&q=80" alt="Thailand floating market with fresh food and boats" loading="lazy">
    ...
    <div class="th-lifestyle-caption">
      <div class="container">
        <div class="th-lifestyle-caption-inner">
          ...
          <p>Street food, floating markets, and tropical adventures — protecting your health means enjoying Thailand to the fullest</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="th-section-dark th-risks-section" id="health-risks">
    ...
    <div class="container th-risks-container">
      <div class="th-section-header th-section-header-dark">
        ...
        <h2 class="th-title-dark">Health Risks When Traveling<br>to Thailand</h2>
      ...
      <div class="th-risks-grid">
        <div class="th-risk-card">
          ...
          <p>Dengue fever is widespread throughout Thailand, including urban areas like Bangkok. While malaria risk is low in most tourist destinations, it remains a concern in rural and border regions. Use DEET-based repellents and wear long sleeves during dawn and dusk. Dengue-carrying mosquitoes bite during the day.</p>
        </div>
        <div class="th-risk-card">
          <div class="th-risk-icon">
        ...
        <div class="th-risk-card">
          ...
          <p>Risk is higher in rural and agricultural areas, particularly rice-growing regions. The virus is spread by mosquitoes and can cause serious brain inflammation. Vaccination is recommended for travellers spending extended time in rural Thailand or visiting during the rainy season (May–October).</p>
        </div>
        <div class="th-risk-card">
          <div class="th-risk-icon">
  ...
  <section class="th-section-dark th-process-section" id="booking">
    ...
    <div class="container th-process-container">
      <div class="th-section-header th-section-header-dark">
        ...
        <h2 class="th-title-dark">How to Get Your Thailand<br>Travel Vaccinations</h2>
      </div>
      ...
      <div class="th-steps-grid">
        ...
        <div class="th-step-card">
          ...
          <p>Our GPhC-registered pharmacists review your itinerary, medical history, and provide personalised Thailand travel health advice. We'll identify exactly which vaccines and medications you need.</p>
        </div>
        <div class="th-step-card">
          <div class="th-step-number">3</div>
          <h3>Same-Day Vaccination</h3>
          <p>Receive your vaccines immediately. We stock all Thailand travel vaccinations and can complete your course before departure. No waiting lists, no delays—get protected the same day.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="th-timeline-grid">
        <div class="th-timeline-card th-timeline-ideal">
          ...
          <p>Best timing for multi-dose vaccines like Hepatitis B and Japanese Encephalitis. Allows your body to develop full immunity before departure. Rabies pre-exposure course can be completed in this timeframe.</p>
        </div>
    ...
    <div class="container th-why-container">
      ...
      <div class="th-why-grid">
        ...
        <div class="th-why-card">
          ...
          <h3>All Thailand Vaccines in Stock</h3>
          <p>No ordering delays—we carry every recommended vaccine for Thailand travel</p>
        </div>
        <div class="th-why-card">
          <div class="th-why-icon">
  ...
  <section class="th-section-dark th-final-cta" id="book-now">
    ...
    <div class="container th-final-cta-container">
      <h2 class="th-title-dark">Book Your Thailand Travel<br>Vaccinations Today</h2>
