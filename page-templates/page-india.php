<?php
/**
 * Template Name: India Travel Health
  ...
  <section class="th-hero">
    ...
    <div class="container th-hero-container">
      <div class="th-hero-content">
        ...
        <p class="th-hero-subtitle"><?php echo esc_html( rl_field( 'india_hero_subtitle', 'Expert travel health advice and essential vaccines for your India trip. Same-day appointments available at our both our Chislehurst locations.' ) ); ?></p>
    ...
    <div class="container">
      ...
      <div class="th-vaccine-category">
        <div class="th-category-header th-category-recommended">
          ...
          <div>
            <h3>Recommended Vaccines for India</h3>
        ...
        <div class="th-vaccine-grid">
          ...
          <div class="th-vaccine-card">
            ...
            <p class="th-vaccine-desc">Common in areas with poor sanitation. Spread through contaminated food and water. Essential for India — street food is a major part of the experience and typhoid is widespread in many regions.</p>
            <div class="th-vaccine-meta">
              <span class="th-vaccine-who">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
          ...
          <div class="th-vaccine-card">
            ...
            <p class="th-vaccine-desc">Recommended if visiting rural areas, especially rice-growing regions of eastern and southern India, or staying for extended periods. Spread by mosquitoes and can cause serious neurological illness.</p>
            <div class="th-vaccine-meta">
              <span class="th-vaccine-who">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
          ...
          <div class="th-vaccine-card">
            ...
            <p class="th-vaccine-desc">Strongly recommended for adventure travellers, rural visitors, and families with children. Stray dogs are extremely common across India, including in cities. Rabies is endemic and India has the highest number of rabies deaths globally.</p>
            <div class="th-vaccine-meta">
              <span class="th-vaccine-who">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
