              ...
              <div class="mega-dropdown">
                <div class="dropdown-content">
                  <div class="dropdown-section">
                    ...
                    <a href="https://chislehurstpharmacygroup.kinsta.cloud/nhs-prescriptions/" class="dropdown-link">
                      <div class="link-icon">
                  ...
                  <div class="dropdown-featured">
                    <div class="featured-card">
                      ...
                      <p>GLP-1 treatments supplied same day. Face-to-face care at both Chislehurst locations — clinically supervised throughout.</p>
                      <div class="featured-trust">
                        <span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 6L9 17l-5-5"/></svg> GPhC-registered pharmacists</span>
              ...
              <div class="mega-dropdown travel-health-dropdown">
                <div class="dropdown-content dropdown-content-4col">
                  <div class="dropdown-section">
                    ...
                    <a href="<?php echo esc_url( home_url( '/typhoid-vaccine-london/' ) ); ?>" class="dropdown-link">
                      <div class="link-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="mobile-nav-body">
        ...
        <div class="mobile-nav-item">
          ...
          <div class="mobile-nav-sub">
            ...
            <a href="<?php echo esc_url( home_url( '/typhoid-vaccine-london/' ) ); ?>" class="mobile-nav-sub-link">Typhoid</a>
